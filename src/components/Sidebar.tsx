...
const mainMenu = [
  ...
  { name: "Schede", href: "/plans", icon: ClipboardIcon },
  { name: "Storico", href: "/history", icon: HistoryIcon },
  { name: "Progressi", href: "/progress", icon: ChartIcon },
];
    ...
    <aside className="w-64 bg-[var(--sidebar-bg)] border-r border-[var(--border)] flex flex-col">
      <div className="px-4 py-5 md:p-6">
        <div className="flex items-center gap-2">
          ...
          <span className="text-lg font-bold text-[var(--text-primary)]">FitDash</span>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-[var(--border)]">
        <div className="flex items-center gap-3 px-3 py-2">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-[var(--text-primary)] truncate">Utente</p>
            <p className="text-xs text-[var(--text-muted)] truncate">utente@email.com</p>
          </div>
